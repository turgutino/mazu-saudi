...
const copy = {
  zh: {
    ...
    kgEyebrow: "参考资料 / 知识图谱",
    kgTitle: "灾害机制与证据图谱",
    kgLead: "多灾种、可溯源、证据受限——组织人工断言、规则映射、数据集观测与文献支持，不发现因果，也不提升预测模型能力。",
    kgSearchPlaceholder: "输入节点名称（例如 ivt、Jeddah、ARST）",
    kgFilterByType: "按节点类型筛选",
    kgFilterByEdge: "按关系类型筛选",
    kgNodeCountLabel: "节点",
    kgEdgeCountLabel: "关系",
    kgClaimBoundary: "机制关系为人工维护的领域断言；文献记录仅表示本地证据匹配与有限核验。图谱不参与模型训练或风险评分，51条观测关联被隔离在独立分析制品中。",
  ...
  en: {
    ...
    kgTitle: "Hazard mechanism & evidence graph",
    kgLead: "Multi-hazard, provenance-aware, evidence-bounded — organizes hand-authored assertions, rule mappings, dataset observations and literature support; it does not discover causality or improve forecast-model skill.",
    kgSearchPlaceholder: "Type a node name (e.g. ivt, Jeddah, ARST)",
    kgFilterByType: "Filter by node type",
    kgFilterByEdge: "Filter by edge type",
    kgNodeCountLabel: "Nodes",
    kgEdgeCountLabel: "Edges",
    kgClaimBoundary: "Mechanism relations are hand-maintained domain assertions; citation records show local evidence matching and limited review only. The graph does not enter model training or risk scoring; 51 observational associations are isolated in a separate analysis artifact.",
