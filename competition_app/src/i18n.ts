...
const copy = {
  zh: {
    ...
    kgEyebrow: "参考资料 / 知识图谱",
    kgTitle: "全球观测机制适用性本体",
    kgLead: "直接浏览后端 SQLite 中的版本化本体，检查指标、状态、环境、机制、证据断言与预测约束之间的关系。",
    kgSearchPlaceholder: "搜索中英文名称或定义（例如 IVT、水汽输送）",
    kgFilterByType: "按本体模块筛选",
    kgFilterByEdge: "按关系类型筛选",
    kgNodeCountLabel: "节点",
    kgEdgeCountLabel: "关系",
    kgClaimBoundary: "该本体组织全球观测中可检验的机制适用性、环境范围与来源追溯。自动提取的关系默认是观测断言，不是因果事实，也不是沙特地区的灾害真值。",
    kgAllModules: "全部模块",
    kgLoading: "正在查询本体数据库",
    kgLoadFailed: "本体服务暂时不可用",
    kgEmpty: "没有找到符合条件的本体资源",
    kgSelectNode: "选择图中的节点查看定义和关系",
    kgDefinition: "定义",
    kgModule: "模块",
    kgResourceType: "资源类型",
    kgVersion: "本体版本",
    kgLiveDatabase: "后端 SQLite · 实时查询",
  ...
  en: {
    ...
    kgEyebrow: "Reference / Knowledge graph",
    kgTitle: "Global observational mechanism applicability ontology",
    kgLead: "Browse the versioned ontology directly from the backend SQLite store and inspect relationships among indicators, states, contexts, mechanisms, evidence assertions and forecast constraints.",
    kgSearchPlaceholder: "Search names or definitions (e.g. IVT, moisture transport)",
    kgFilterByType: "Filter by ontology module",
    kgFilterByEdge: "Filter by edge type",
    kgNodeCountLabel: "Nodes",
    kgEdgeCountLabel: "Edges",
    kgClaimBoundary: "This ontology organizes testable mechanism applicability, environmental scope and provenance extracted from global observations. Automatically extracted relations are observational assertions by default, not causal facts or Saudi hazard truth.",
    kgAllModules: "All modules",
    kgLoading: "Querying the ontology database",
    kgLoadFailed: "The ontology service is unavailable",
    kgEmpty: "No ontology resources match these filters",
    kgSelectNode: "Select a graph node to inspect its definition and relations",
    kgDefinition: "Definition",
    kgModule: "Module",
    kgResourceType: "Resource type",
    kgVersion: "Ontology version",
    kgLiveDatabase: "Backend SQLite · live query",
