...
整体框架暂用工作名 **MAZU-Saudi HAMF**。其中 HAMF 表示 Hazard-Aware Multi-scale Fusion（灾种感知多尺度融合）。该名称和方法的新颖性需要在正式论文选题前完成文献查新，本设计不预先声称原创。
...
HAMF-Light 不强迫所有灾害使用一种空间编码，而为每个灾种和预报时效学习三类信息的组合权重：
